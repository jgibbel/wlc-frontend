    ...
    render() {
        return (
            <div className="page-container">
                ...
                <p className="indent-more p">This new pilot program is open to any woman or trans person who:</p>
                ...
                <p className="indent-more p">Current WLC members may nominate up to two leaders who meet these criteria and all nominations must be submitted by no later than April 20, 2020. Any woman or trans person interested in being mentored should reach out to a current member of the WLC to request a nomination or send an email to info@wlcsocialimpact.com.</p>
